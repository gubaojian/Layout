...
@implementation GImageFetcher

static GImageFetcher *shareFetcher = nil;

+(GImageFetcher*) shareFetcher{
    if (shareFetcher == nil) {
        shareFetcher = [[GImageFetcher alloc] init];
    }
    return shareFetcher;
}
...
-(UIImage*)loadHttpImageUrl:(NSString*)imageUrl{
    NSString* md5 = [GHash md5:imageUrl];
